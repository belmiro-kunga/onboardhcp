<x-admin-layout title="Vídeos" active-menu="videos" page-title="Gestão de Vídeos">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h2 class="text-2xl font-bold text-gray-900">Gestão de Vídeos</h2>
            <p class="text-sm text-gray-600">Gerencie conteúdo de vídeo para treinamentos</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="widget">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Biblioteca completa</p>
                </div>
            </div>
        ...
        <div class="widget">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-600">Horas de Conteúdo</p>
        ...
        <div class="widget">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Total de views</p>
                </div>
            </div>
            <div class="flex items-center mt-4">
    ...
    <!-- Content -->
    <div class="card">
        <h3 class="text-lg font-semibold text-gray-900 mb-4">Biblioteca de Vídeos</h3>
        <div class="text-center py-12">
            <svg class="w-12 h-12 text-gray-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"></path>
            </svg>
            <h3 class="text-lg font-medium text-gray-900 mb-2">Funcionalidade em Desenvolvimento</h3>
            <p class="text-gray-500">A gestão de vídeos será implementada em breve.</p>
        </div>
    </div>
</x-admin-layout>